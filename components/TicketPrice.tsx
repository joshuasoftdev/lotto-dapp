...
function TicketPrice() {
  ...
  return (
    <div className="stats-container space-y-2 bg-[url('/profile.png')] bg-auto bg-no-repeat bg-center bg-red-800 filter hue-rotate-90">
      <div className="stats-container">
        ...
        <button
          ...
          className="mt-5 w-full bg-gradient-to-br from-orange-500 to-emerald-800 px-10 py-5 rounded-md font-semibold text-white shadow-xl disabled:from-gray-600 disabled:to-gray-100 disabled:text-gray-100 disabled:cursor-not-allowed  hover:shadow-cyan-500/50 hover:ease-in-out duration-300">
